  ...
  return (
    <div className="  px-5 bg-gray27">
      <div className=" max-w-[1440px] pt-[24px] pb-[58px] rounded-10  mx-auto my-0">
        <div className="flex items-center justify-between px-[10px] mxl:px-0 ">
          <h2 className=" text-[25px] leading-[36px] font-semibold text-blue3 lg:text-[22px] lg:leading-[28px]">
            Featured Luxury Brands
          </h2>
          <button className="text-blue3 border border-blue3 py-2 px-[22px] rounded-[50px] whitespace-nowrap">
            See All
          </button>
        </div>
        <CustomSlider>
